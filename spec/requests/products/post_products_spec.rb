RSpec.describe 'POST /api/v1/products', type: :request do
  let(:params) { { data: { type: 'products', attributes: { name: 'Test Product', price: 20, description: 'Lorem ipsum' } } } }
  ...
  context 'valid parameters' do
    ...
    # Fails because of bug that when price is without decimals, then one decimal place is missing
    it 'returns price' do
    ...
    it 'returns description' do
      ...
      expect(description).to eq 'Lorem ipsum'
    end
